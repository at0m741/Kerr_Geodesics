...
int main(int argc, char **argv)
{
	...
	//double x[4] = {Rs * 100000, M_PI / 2, M_PI, 0.0}; // Position initiale (t, r, θ, φ)
	//double v[4] = {1.0, 0.01, 1.0, 0.1};          // Vitesse initiale (dt/dλ, dr/dλ, dθ/dλ, dφ/dλ)
    ldouble_a H = 1.0;
    ...
    geodesic(x, v, 1.3, christoffel_sym, 0.00000008, store_geodesic_point);
	printf("Rs = %f\n", Rs * 1000);
	printf(r == Rs * 1000 ? "r = Rs\n" : "r != Rs\n");
	printf("r = %f\n", x[1]);
	print_arch();
