...
/*   Updated: 2024/09/01 02:39:55 by at0m             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    DLOOP gcov[j][k] = 0.;
    ALIGNED double dXpdX[NDIM];
    ALIGNED double r, th;
	ALIGNED double R0 = 1.0;
	ALIGNED double hslope = 0.3;
    ALIGNED double sth, cth, s2, rho2;
...
{
	ALIGNED double  R0 = 1.0, Rin = 2.0, Rout = 10.0, hslope = 0.3;
    *r = expf(X[1]) + R0;
...
{
	int	j, k;
	ALIGNED double sth, cth, a2, r2, r3, DD, mu;
	DLOOP gcon[j][k] = 0.;
